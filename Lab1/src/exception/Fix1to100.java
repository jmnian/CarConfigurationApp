...
public class Fix1to100 {
	...
	public void fixMissingAutomobileName(Automobile auto) {
		auto.setName("Missing");
		System.out.println("Automobile name is missing");
	}
	...
	public void fixMissingAutomobileNameAndPrice(Automobile auto) {
		auto.setBasePrice(0);
		auto.setName("Missing");
		System.out.println("Please check your input file format, the first line should be Automobile's name and the second line should be it's base price");
	}
	...
	public void fixDimension(Automobile auto, int endAt) {
		if(endAt == 0) {
			...
			auto.setOptionSetArray(auto.getOptionSetSize() + 1, auto.getOptionSetArray());
	...
	public void fixOptionData(Automobile auto) {
		System.out.println("Because of bad input data, program ended half way through instantiating the Automobile object named: " + auto.getName());
	}
}
